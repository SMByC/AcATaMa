...
def test_pixel_count_without_nodata(plugin, unwrap):
    # restore
    ...
    pixel_count = get_pixel_count_by_pixel_values(plugin.dockwidget.QCBox_ThematicMap.currentLayer(),
                                                  band=2, nodata=None)
...
def test_pixel_count_with_nodata(plugin, unwrap):
    # restore
