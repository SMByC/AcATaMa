...
class ClassificationDialog(QtGui.QDialog, FORM_CLASS):
    ...
    def __init__(self, sampling_layer, columns, rows):
        ...
        self.radiusFitToSample.setRange(0, 360 if layer_dist_unit == QGis.Degrees else 10e6)
        self.radiusFitToSample.setDecimals(4 if layer_dist_unit in [QGis.Kilometers, QGis.NauticalMiles, QGis.Miles, QGis.Degrees] else 1)
        self.radiusFitToSample.setSingleStep(0.0001 if layer_dist_unit in [QGis.Kilometers, QGis.NauticalMiles, QGis.Miles, QGis.Degrees] else 1)
